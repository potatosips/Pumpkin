...
function buildSetup() {
  return [
    'tp @s 400 85 28',
    'kill @e[type=item,x=390,y=60,z=20,dx=30,dy=35,dz=15]',
    'fill 390 67 25 420 76 31 air',
    'fill 390 68 25 420 68 31 minecraft:netherrack',
    
    // Test 1: Crimson fungus on crimson nylium
    'setblock 392 69 28 minecraft:crimson_nylium',
    
    // Test 2: Warped fungus on warped nylium
    'setblock 396 69 28 minecraft:warped_nylium',
    
    // Test 3: Crimson roots on soul soil
    'setblock 400 69 28 minecraft:soul_soil',
    
    // Test 4: Warped roots on warped nylium
    'setblock 404 69 28 minecraft:warped_nylium',
    
    // Test 5: Nether sprouts on warped nylium
    'setblock 408 69 28 minecraft:warped_nylium',
    
    // Test 6: Support removal
    'setblock 412 69 28 minecraft:crimson_nylium',
  ];
}

const placementPhase = [
    'setblock 392 70 28 minecraft:crimson_fungus',
    'setblock 396 70 28 minecraft:warped_fungus',
    'setblock 400 70 28 minecraft:crimson_roots',
    'setblock 404 70 28 minecraft:warped_roots',
    'setblock 408 70 28 minecraft:nether_sprouts',
    'setblock 412 70 28 minecraft:crimson_fungus',
];

const breakPhase = [
    'setblock 412 69 28 minecraft:air',
];

const verify = [
  'execute if block 392 70 28 minecraft:crimson_fungus run say PASS_CRIMSON_FUNGUS_ON_CRIMSON_NYLIUM',
  'execute if block 396 70 28 minecraft:warped_fungus run say PASS_WARPED_FUNGUS_ON_WARPED_NYLIUM',
  'execute if block 400 70 28 minecraft:crimson_roots run say PASS_CRIMSON_ROOTS_ON_SOUL_SOIL',
  'execute if block 404 70 28 minecraft:warped_roots run say PASS_WARPED_ROOTS_ON_WARPED_NYLIUM',
  'execute if block 408 70 28 minecraft:nether_sprouts run say PASS_NETHER_SPROUTS_ON_WARPED_NYLIUM',
  'execute unless block 412 70 28 minecraft:crimson_fungus run say PASS_SUPPORT_REMOVAL_BREAK',
];
...
function run(name, port) {
  ...
  client.on('end', () => {
    if (++finished === 2) {
      console.log('\n=== NETHER FLORA DUAL-SERVER DIFFERENTIAL SUMMARY ===');
      const expected = [
        'PASS_CRIMSON_FUNGUS_ON_CRIMSON_NYLIUM',
        'PASS_WARPED_FUNGUS_ON_WARPED_NYLIUM',
        'PASS_CRIMSON_ROOTS_ON_SOUL_SOIL',

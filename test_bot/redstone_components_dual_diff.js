...
function buildSetup() {
  return [
    'tp @s 1115 85 28',
    'kill @e[type=item,x=1100,y=60,z=20,dx=45,dy=35,dz=15]',
    'fill 1100 67 25 1145 76 31 air',
    'fill 1100 68 25 1145 68 31 minecraft:stone',
    
    // Foundations
    'setblock 1102 69 28 minecraft:stone',
    'setblock 1106 69 28 minecraft:redstone_block',
    'setblock 1110 69 28 minecraft:stone',
    'setblock 1114 69 28 minecraft:stone',
    'setblock 1118 69 28 minecraft:stone',
    'setblock 1122 69 28 minecraft:stone',
  ];
}

const placementPhase = [
    'setblock 1102 70 28 minecraft:redstone_block',
    'setblock 1106 70 28 minecraft:redstone_lamp',
    'setblock 1110 70 28 minecraft:redstone_lamp',
    'setblock 1114 70 28 minecraft:redstone_ore',
    'setblock 1118 70 28 minecraft:deepslate_redstone_ore',
    'setblock 1122 70 28 minecraft:redstone_ore[lit=true]',
];

const verify = [
  'execute if block 1102 70 28 minecraft:redstone_block run say PASS_REDSTONE_BLOCK',
  'execute if block 1106 70 28 minecraft:redstone_lamp run say PASS_REDSTONE_LAMP_LIT',
  'execute if block 1110 70 28 minecraft:redstone_lamp run say PASS_REDSTONE_LAMP_UNLIT',
  'execute if block 1114 70 28 minecraft:redstone_ore run say PASS_REDSTONE_ORE_UNLIT',
  'execute if block 1118 70 28 minecraft:deepslate_redstone_ore run say PASS_DEEPSLATE_REDSTONE_ORE_UNLIT',
  'execute if block 1122 70 28 minecraft:redstone_ore run say PASS_REDSTONE_ORE_LIT',
];
...
function run(name, port) {
  ...
  client.on('end', () => {
    if (++finished === 2) {
      console.log('\n=== REDSTONE COMPONENTS DUAL-SERVER DIFFERENTIAL SUMMARY ===');
      const expected = [
        'PASS_REDSTONE_BLOCK',
        'PASS_REDSTONE_LAMP_LIT',
        'PASS_REDSTONE_LAMP_UNLIT',
        'PASS_REDSTONE_ORE_UNLIT',
        'PASS_DEEPSLATE_REDSTONE_ORE_UNLIT',
        'PASS_REDSTONE_ORE_LIT',
      ];
      let matchCount = 0;

...
function buildSetup() {
  return [
    'tp @s 430 85 28',
    'kill @e[type=item,x=420,y=60,z=20,dx=30,dy=35,dz=15]',
    'fill 420 67 25 450 76 31 air',
    'fill 420 68 25 450 68 31 minecraft:stone',
    
    // Test 1: Wither rose on soul sand
    'setblock 422 69 28 minecraft:soul_sand',
    
    // Test 2: Spore blossom hanging from ceiling
    'setblock 426 71 28 minecraft:stone',
    
    // Test 3: Brown mushroom on mycelium
    'setblock 430 69 28 minecraft:mycelium',
    
    // Test 4: Red mushroom on podzol
    'setblock 434 69 28 minecraft:podzol',
    
    // Test 5: Support removal for spore blossom
    'setblock 438 71 28 minecraft:stone',
  ];
}

const placementPhase = [
    'setblock 422 70 28 minecraft:wither_rose',
    'setblock 426 70 28 minecraft:spore_blossom',
    'setblock 430 70 28 minecraft:brown_mushroom',
    'setblock 434 70 28 minecraft:red_mushroom',
    'setblock 438 70 28 minecraft:spore_blossom',
];

const breakPhase = [
    'setblock 438 71 28 minecraft:air',
];

const verify = [
  'execute if block 422 70 28 minecraft:wither_rose run say PASS_WITHER_ROSE_ON_SOUL_SAND',
  'execute if block 426 70 28 minecraft:spore_blossom run say PASS_SPORE_BLOSSOM_ON_CEILING',
  'execute if block 430 70 28 minecraft:brown_mushroom run say PASS_BROWN_MUSHROOM_ON_MYCELIUM',
  'execute if block 434 70 28 minecraft:red_mushroom run say PASS_RED_MUSHROOM_ON_PODZOL',
  'execute unless block 438 70 28 minecraft:spore_blossom run say PASS_SUPPORT_REMOVAL_BREAK',
];
...
function run(name, port) {
  ...
  client.on('end', () => {
    if (++finished === 2) {
      console.log('\n=== SPECIAL FLORA DUAL-SERVER DIFFERENTIAL SUMMARY ===');
      const expected = [
        'PASS_WITHER_ROSE_ON_SOUL_SAND',
        'PASS_SPORE_BLOSSOM_ON_CEILING',
